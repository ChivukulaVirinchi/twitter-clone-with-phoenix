defmodule XDemo.Timeline do
  ...
  def subscribe() do
    Phoenix.PubSub.subscribe(XDemo.PubSub, "posts")
  end

  defp broadcast({:error, _reason} = error, _event), do: error

  defp broadcast({:ok, %Post{} = post}, event) do
    Phoenix.PubSub.broadcast(XDemo.PubSub, "posts", {event, post})
    {:ok, post}
  end
end
